...
- [ ] Типы данных и переменные (строгая типизация vs динамическая)
- [ ] Классы и объекты (class в Java vs class в JS)
- [ ] ООП: наследование, интерфейсы, абстрактные классы
- [ ] Коллекции: List, Map, Set (аналог Array и Object в JS)
- [ ] Исключения: try/catch, checked vs unchecked
