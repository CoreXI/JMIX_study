...
**Цель блока:** Читать и писать Java-код уверенно. Понять, чем Java отличается от JS на уровне мышления.

## Темы блока

| # | Тема | Теория | Задание | Статус |
|---|------|--------|---------|--------|
| 1 | Типы данных и переменные | [01-types/theory.md](01-types/theory.md) | [01-types/task.md](01-types/task.md) | не начата |
...
Темы идут последовательно — каждая опирается на предыдущую.
Схема работы с каждой темой:
1. Читаешь `theory.md`
2. Выполняешь `task.md`
3. Показываешь решение — разбираем вместе
4. Ставим `[x]` в `stack-map.md`
